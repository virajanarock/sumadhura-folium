...
<html>
  ...
  <!--devstart-->
<!--<script>-->
<!--  let projectname = "sumadhura-folium-v2"-->
<!--  function autoRefreshPage() {-->
<!--    fetch('http://marketing-dashboards.anarock.com/api/v0/lastupdated?project='+projectname, {-->
<!--      method: 'get',-->
<!--      credentials:"include"-->
...
<!--devend-->
<!--prod!!!
  <base href="https://dpgvclkvnnsee.cloudfront.net/microsites/sumadhura-folium-v2/" />
!!!-->
...
<script>
  function handleFormSubmit(e,id) {
    ...
    if(error!=''){
     ...
     var formdata = 'mobile='+phone+'&email='+email+'&name='+name+''
    	  $.ajax({
    type: "POST",
    url: 'otp.php',
    data: formdata,
    ...
    let campaign_id = 'SUMADHURA-LP'
    let channel_name = 'anarock-digital'
    let api_key = '28f09994f11b86b8'
    
    let validateResponse;
    
    let submitLead = (validateResponse) => {
      let otp = prompt('Please Enter OTP sent to mobile number '+validateResponse.phone)
			if(!otp) return;
    ...
    Anarock.requestOTP({
      api_key: api_key, // get your auth key from support team
      env: 'production',
      host: 'anarock.com',
      channel_name: channel_name,
      campaign_id: campaign_id,
      country_code: ccode,
      phone: phone, // valid 10-digits phone number entered by the user
